...
public abstract class AbstractOrderService implements IOrderService {
    ...
    public PayOrderEntity createOrder(ShopCartEntity shopCartEntity) {
        try {
            ...
            if (Objects.nonNull(unpaidOrderEntity) && PayStatusVO.WAIT.equals(unpaidOrderEntity.getPayStatus()) && Objects.nonNull(unpaidOrderEntity.getPayUrl())) {
                ...
                return PayOrderEntity.builder()
                        ...
                        .build();
            } else if (Objects.nonNull(unpaidOrderEntity) && Objects.isNull(unpaidOrderEntity.getPayUrl())) {
